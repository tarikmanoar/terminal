...
POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(custom_apple_icon dir_writable dir)
POWERLEVEL9K_CUSTOM_APPLE_ICON="echo "
POWERLEVEL9K_CUSTOM_APPLE_ICON_BACKGROUND=blue
POWERLEVEL9K_CUSTOM_APPLE_ICON_FOREGROUND=000
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(root_indicator  status vcs)
...
plugins=(git composer laravel5 last-working-dir laravel4 zsh-autosuggestions zsh-syntax-highlighting)
...
#
# Example aliases
alias lp="cd /media/manoar/HDD/SERVER/back-end/laravel/"
...
alias npmr="npm install && npm run --dev"
